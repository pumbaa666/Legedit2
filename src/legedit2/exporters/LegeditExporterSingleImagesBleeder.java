	...
	class Task extends SwingWorker<Void, Void>
	{
		...
		public BufferedImage resizeImage(BufferedImage imageIcon)
		{
			...
			if(fancyBleed)
			{
				...
				{
					g.drawImage(imageIcon, xPad - increment, yPad - increment, w + xPad + increment, h + yPad + increment, 0, 0, imageIcon.getWidth(), imageIcon.getHeight(), null);

					increment--;
				}
			}

			g.drawImage(imageIcon, xPad, yPad, w + xPad, h + yPad, 0, 0, imageIcon.getWidth(), imageIcon.getHeight(), null);
			g.dispose();
