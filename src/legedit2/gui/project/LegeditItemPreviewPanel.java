...
public class LegeditItemPreviewPanel extends JPanel
{
	...
	{
		if(lastItem == -1 || selectedItem == null || lastItem != selectedItem.hashCode())
		{
	...
	public void resetPreviewPanel()
	{
		...
		if(selectedItem != null)
		{
			...
			else if(selectedItem instanceof Card)
			{
				...
				if(imageMap.get(selectedItem) == null)
					getInnerPanel().add(new JLabel("Loading..."));
				else
					getInnerPanel().add(new JLabel(new ImageIcon(imageMap.get(selectedItem))));
			}
			else
			{
				getInnerPanel().setLayout(new GridLayout(1, 1));
	...
	{
		if(lastItem == -1 || selectedItemType == null || lastItem != selectedItemType.hashCode())
		{
