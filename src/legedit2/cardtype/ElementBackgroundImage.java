...
public class ElementBackgroundImage extends CustomElement
{
	...
	public void drawElement(Graphics2D g)
	{
		...
		if(templateFile)
		{
			file = CustomCardMaker.templateFolder + File.separator + template.getTemplateName() + File.separator + path;
		}
		else
			file = path;
	...
	{
		return "<bgimage name=\"" + replaceNonXMLCharacters(name) + "\" path=\"" + replaceNonXMLCharacters(path) + "\" zoom=\"" + zoom + "\" imageOffsetX=\"" + imageOffsetX + "\" imageOffsetY=\"" + imageOffsetY + "\" />\n";
	}
